...
// need past index into getStory....
  // ✅ Step 8: Get current story title
  String getStory() {
    return _storyData[_storyNumber].storyTitle;
  }

  // ✅ Step 11: Get current choice 1
  String getChoice1() {
    return _storyData[_storyNumber].choice1;
  }

  // ✅ Step 12: Get current choice 2
  String getChoice2() {
    return _storyData[_storyNumber].choice2;
  }

  // ✅ Step 16: Advance to next story
  ...
  // ✅ Step 22: Reset to start
  void restart() {
    _storyNumber = 0;
  }

  // ✅ Step 27: Should the second button be visible?
